  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-zinc-400">Bagalkot, Karnataka</span>.
        Primarily <span className="text-violet-400/90">TypeScript</span>.{" "}
...
function GitHubIcon() {
  return (
    <svg className="w-4 h-4 transition-colors duration-300 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
      <path
        fillRule="evenodd"
...
function BlogIcon() {
  return (
    <svg className="w-4 h-4 transition-colors duration-300 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        strokeLinecap="round"
