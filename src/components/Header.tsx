          ...
          <AnimatePresence>
            {showTooltip && (
              <motion.div
                ...
                className="absolute left-1/2 -translate-x-1/2 bottom-full mb-2 px-2.5 py-1.5 text-xs font-medium text-zinc-200 bg-zinc-800 border border-zinc-700 rounded-md whitespace-nowrap shadow-lg"
              >
