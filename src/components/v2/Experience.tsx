        ...
        {experience.map((job, index) => {
          ...
          return (
            <motion.div
              ...
              className="group relative p-5 sm:p-6 bg-zinc-900/40 hover:bg-zinc-900/60 border border-zinc-800/50 hover:border-zinc-700/60 rounded-2xl transition-all duration-300"
            >
              {/* Current indicator line */}
              {isCurrent && (
                <div className="absolute left-0 top-6 bottom-6 w-0.5 bg-emerald-400 rounded-full" />
              )}
              ...
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
                <div className="flex-1 min-w-0 pl-3 sm:pl-4">
                  ...
                  <div className="flex flex-wrap items-center gap-2.5 mb-2">
                    <h3 className="font-semibold text-base sm:text-lg text-zinc-200 group-hover:text-white transition-colors">
                      {job.role}
                    </h3>
                    {isCurrent && (
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-sm text-zinc-400 hover:text-violet-400 transition-colors mb-2"
                  >
                    <BuildingIcon />
                    {job.company}
                    <ExternalLinkIcon />
